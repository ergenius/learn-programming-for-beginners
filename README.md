...
- On any subject always search and read the coresponding wikipedia page (if any) after reading or watching the more accesible content or tutorials. On wikipedia, the information is presented in a more professional way, using the right academic terms, wich will be very usefull in  future jobs interviews.
